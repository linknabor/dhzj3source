...
.select-item {
    background: url('../assets/images/pay/icon_unselect.png') no-repeat ;
...
.selected {
	background: url('../assets/images/pay/icon_selected.png') no-repeat ;
	background-size: 0.32rem;
   background-position: center;
}
.payed{
	background: url('../assets/images/pay/icon_cancel.png') no-repeat ;
	background-size: 0.32rem;
   background-position: center;
}
.info{
...
.bottom .date{
	...
	background: url('../assets/images/pay/icon_time_gray.png') no-repeat left center;
